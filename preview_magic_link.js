#!/usr/bin/env node
/*
 * PathBinder — Magic link email preview generator.
 *
 * Renders the magic-link template (api/_lib/magic-link-template.js)
 ...
 *
 * USAGE
 *   node preview_magic_link.js
 *
 * Output: ./email_previews/magic-link.html
 */

const fs   = require('fs');
const path = require('path');
const { renderHtml } = require('./api/_lib/magic-link-template');
...
function main() {
  ...
  const outPath = path.join(OUTPUT_DIR, 'magic-link.html');
