...
def main():
    ...
    def mirror_one(row):
        ...
        # 3b. Variants — 200/400px WebP siblings. Non-fatal; the
        # browser's onerror handler falls back to the main image when
        # a variant is missing, so older mirrored rows still render.
        try:
